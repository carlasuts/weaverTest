	...
	public static void main(String[] args) {
		...
		try {
			...
			while (rs.next()) {
				...
				cInfPatDat.setPosnr(rs.getString(""));
				cInfPatDat.setIdnrk(rs.getString(""));
				cInfPatDat.setMenge(rs.getString(""));
				cInfPatDat.setMeins(rs.getString(""));
				cInfPatDat.setAusch(rs.getString(""));
				cInfPatDat.setAlpgr(rs.getString(""));
