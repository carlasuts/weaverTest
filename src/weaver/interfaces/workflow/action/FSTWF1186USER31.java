...
public class FSTWF1186USER31 implements Action {
	public FSTWF1186USER31() {
	}
	...
	public String execute(RequestInfo request) {
        ...
        try {
            ...
            sql = "update formtable_main_78 set djs31 = '"+ receivedpersonids +"' where requestid = '"+ requestID +"' ";
            rs.executeSql(sql);
            ...
            baseBean.writeLog("------------------------------------------------------------------------");
            baseBean.writeLog("FSTWF1186USER31 error:" + var11.getMessage());
            baseBean.writeLog("------------------------------------------------------------------------");
