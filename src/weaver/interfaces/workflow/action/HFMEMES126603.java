...
import weaver.interfaces.schedule.HFMEMES83SCH;
...
public class HFMEMES126603 implements Action {
	...
	public String execute(RequestInfo request) {
		try {
			...
			if(cz.equals("3")){
				...
				String retSrcs = HFMEMES83SCH.readInterfacePost(url,req.toString());
