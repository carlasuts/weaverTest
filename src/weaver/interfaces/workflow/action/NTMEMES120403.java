...
public class NTMEMES120403 implements Action {
	...
	public String execute(RequestInfo request) {
		try {
			...
			if(cz.equals("3")){
				...
				sql = "insert into STYC_END_MIDDLE(id,lot_id,oper,flag,update_time) values (" + 
				maxid + "," + 
				"'" + lot_id + "'," + 
				"'" + oper + "'," + 
				"'200'," +
				...
				//客户处置或QA处置
				if(!tecz.equals("")){
					sql = "update STYC_MIDDLE set resv_field4 = '" + tecz + "',UPDATE_TIME = '" + udpatetime + "' where id = " + id;
