...
public class CCMEMES6601 implements Action {
	public String execute(RequestInfo request) {
        try {
	        ...
	        baseBean.writeLog("CCMEMES6601 requestid:" + rid);
...
//	            request.getRequestManager().setMessagecontent("客户未放行");
				...
				baseBean.writeLog("CCMEMES6601 sql:" + sql1);
				rs.executeSql(sql1);
	        }else{
	        ...
	        baseBean.writeLog("------------------------------------------------------------------------");
	        baseBean.writeLog("HFMEMES126501 error:" + e.getMessage());
	        baseBean.writeLog("------------------------------------------------------------------------");
