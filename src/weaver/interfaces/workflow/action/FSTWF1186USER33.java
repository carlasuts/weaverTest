...
public class FSTWF1186USER33 implements Action {
	public FSTWF1186USER33() {
	}
	...
	public String execute(RequestInfo request) {
        ...
        try {
            ...
            sql = "update formtable_main_78 set djs33 = '"+ receivedpersonids +"' where requestid = '"+ requestID +"' ";
            rs.executeSql(sql);
            ...
            baseBean.writeLog("------------------------------------------------------------------------");
            baseBean.writeLog("FSTWF1186USER33 error:" + var11.getMessage());
            baseBean.writeLog("------------------------------------------------------------------------");
