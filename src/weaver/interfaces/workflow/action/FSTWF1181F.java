...
public class FSTWF1181F implements Action {
	public String execute(RequestInfo request) {
		try {
			...
			baseBean.writeLog("FSTWF1181F requestid:" + rid);
			...
			baseBean.writeLog("FSTWF1181F sql:" + sql);
			rs.executeSql(sql);
			rs.next();
			...
			baseBean.writeLog("FSTWF1181F src:" + src);
	        ...
	        baseBean.writeLog("FSTWF1181F Bukrs:" + Bukrs);
	        baseBean.writeLog("FSTWF1181F Cntnr:" + Cntnr);
	        baseBean.writeLog("FSTWF1181F Gjahr:" + Gjahr);
	        baseBean.writeLog("FSTWF1181F Auser:" + Auser);
	        baseBean.writeLog("FSTWF1181F Flag:" + Flag);
	        baseBean.writeLog("FSTWF1181F Astat:" + Astat);
	        baseBean.writeLog("FSTWF1181F Rsnrj:" + Rsnrj);
	        baseBean.writeLog("FSTWF1181F Zsentid:" + Zsentid);
			...
			String err = result;
			baseBean.writeLog("FSTWF1181F sapresult:" + result);
			...
			if(!result.toUpperCase().equals("S")){
		        ...
		        baseBean.writeLog("FSTWF1181F:SAP调用失败，请联系管理员");
			}
			//如果是退回的话
			if(Astat.equals("R")){
			...
			baseBean.writeLog("------------------------------------------------------------------------");
			baseBean.writeLog("FSTWF1181F error:" + e.getMessage());
			baseBean.writeLog("------------------------------------------------------------------------");
