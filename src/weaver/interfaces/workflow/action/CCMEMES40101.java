...
public class CCMEMES40101 implements Action {
	...
	public String execute(RequestInfo request) {
		try {
			...
			String sql = "select TIGGERID,cz1,sfqcqr from formtable_main_40 where requestid = " + request.getRequestid();
			...
			baseBean.writeLog("------------------------------------------------------------------------");
			baseBean.writeLog("HFMEMES126401 error:" + e.getMessage());
			baseBean.writeLog("------------------------------------------------------------------------");
