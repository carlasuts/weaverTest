...
public class FSTMES83SCH extends BaseCronJob  {
	public void execute() {
		...
		try {
			...
			while(rs.next()){
				...
				if( (RESV_FIELD5.equals("VD_LOW_YIELD") && (!"BIN97".equals(TOPBIN1_PROMPT) && !"BIN99".equals(TOPBIN1_PROMPT)&& !"GXN".equals(TOPBIN1_PROMPT)
								&& !"BROKEN".equals(TOPBIN1_PROMPT)&& !"LOST".equals(TOPBIN1_PROMPT)
								&& !"VI DEFECT".equals(TOPBIN1_PROMPT) ))
						|| (RESV_FIELD5.equals("VD_LOW_YIELD") &&(!"".equals(TOPBIN2_PROMPT) &&!"BIN97".equals(TOPBIN2_PROMPT)&& !"GXN".equals(TOPBIN2_PROMPT) 
					...
					Property[] propertyArray = new Property[37];
