...
@XmlType(name = "WorkflowRequestLog", propOrder = { "agentor", "agentorDept", "annexDocHtmls", "id", "nodeId",
		"nodeName", "operateDate", "operateTime", "operateType", "operatorDept", "operatorId", "operatorName",
		"operatorSign", "receivedPersons", "remark", "remarkSign", "signDocHtmls", "signWorkFlowHtmls" })
