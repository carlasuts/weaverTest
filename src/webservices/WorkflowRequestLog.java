...
public class WorkflowRequestLog  implements java.io.Serializable {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof weaver.workflow.webservices.WorkflowRequestLog)) return false;
        weaver.workflow.webservices.WorkflowRequestLog other = (weaver.workflow.webservices.WorkflowRequestLog) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(weaver.workflow.webservices.WorkflowRequestLog.class, true);
