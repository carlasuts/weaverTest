...
<%@include file="/systeminfo/init_wev8.jsp" %>
   <%
    ...
    if(type.equals("del")){
    	...
    	sql = "insert into MDM_OPER_MTRL_REF(id,oper_fk,mtrl_group_fk,oper_role_fk,oper_role_pk_id,mustfill_flag) values (SYS_GUID()||'',"+
				"'" + oper_fk + "'," +
				"'" + mtrl_group_fk + "'," +
				"'" + oper_role_fk + "'," +
				"'" + oper_role_pk_id + "'," +
    ...
    response.sendRedirect("MDM_OPER_MTRL_REF.jsp");
   %>
