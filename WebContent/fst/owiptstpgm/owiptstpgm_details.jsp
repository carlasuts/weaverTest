...
<%
	...
	if(!p_id.equals("")){
		rs.executeSql("select custid,dqidh,dqidbbh,dqpmlist,scwj,BFBZ,gdtime from formtable_main_110 where custid ='"+custid_id+"' and dqidh = '"+ dqidh_id +"' and dqidbbh = '"+ dqidbbh_id +"' ");
		if(rs.next()){
					...
					<table style="width: 80%" class=ListStyle>
						<TBODY>
							...
							<TR>
								...
								<td align="left">
								<a href="http://172.16.60.63:8080/docs/docs/DocDspExt.jsp?id=<%=scwj %>&imagefileId=<%=IMAGEFILEID %>"  target="_blank">预览/下载点击这里</a> 
								</td>
							</TR>
					</TABLE>
				</FORM>
