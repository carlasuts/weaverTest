...
if(!dqpmlist.equals("")){
	sqlwhere += " and dqpmlist like '%" + dqpmlist.replace("\"", "'||'&'||'quot;'||'") + "%'";
}
		...
		<TABLE width="100%">
			<tr>
				<td valign="top">
		            ...
		            String fromSql  = " (select concat(concat(concat(concat(custid,'-'),dqidh),'-'),dqidbbh)as id ,custid,dqidh,dqidbbh, max(bfbz) as bb,dqpmlist,gdtime from formtable_main_93  where  dqidh >' ' and cq = '1' group by concat(concat(concat(concat(custid,'-'),dqidh),'-'),dqidbbh) , custid,dqidh,dqidbbh ,dqpmlist,gdtime )";
