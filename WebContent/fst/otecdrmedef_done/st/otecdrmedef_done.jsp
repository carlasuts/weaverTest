...
String substrate_type = Util.null2String(request.getParameter("substrate_type"));
...
String sqlwhere = " where 1 = 1 and (tzbb, tzbh) in (select max(To_Number(tzbb)),tzbh from  otecdrmedef_st group by tzbh) and WORLFLOWCLOSE = 'Y'  ";
...
if(!substrate_type.equals("")){
	sqlwhere += " and substrate_type like '%" + substrate_type + "%'";
}
...
<tr>
	...
	<td valign="top">
		...
		<TR>
			...
			<td NOWRAP width='5%'>基板型号</td>
			<td class=FIELD width='10%'>
			<input type=text id='substrate_type' name='substrate_type' value='<%=substrate_type%>'></td>
		</TR> 
		<TR>
		...
		<TABLE width="100%">
			<tr>
				<td valign="top">
		        	<%
		            String backfields = "custmat,custid,TZLXNAME,tzbh,tzbb,pkg,pkld,CREATE_TIME,matdesc,substrate_type ";
		            String fromSql  = " otecdrmedef_st ";
		            ...
		            tableString =" <table  instanceid=\"contract\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
								 ...
								 "			<col width=\"10%\" text=\"图纸编号\" column=\"tzbh\" orderkey=\"tzbh\" />"+
								 "			<col width=\"5%\" text=\"图纸版本\" column=\"tzbb\" orderkey=\"tzbb\" />"+
								 "			<col width=\"5%\" text=\"客户号\" column=\"custid\" orderkey=\"custid\"  />"+
								 "			<col width=\"10%\" text=\"客户品名\" column=\"custmat\" orderkey=\"custmat\"  />"+
								 "			<col width=\"10%\" text=\"品名描述\" column=\"matdesc\" orderkey=\"matdesc\"  />"+
								 "			<col width=\"10%\" text=\"封装外形\" column=\"pkld\" orderkey=\"pkld\"  />"+
								 "			<col width=\"5%\" text=\"封装大类\" column=\"pkg\" orderkey=\"pkg\" />"+
								 "			<col width=\"10%\" text=\"基板型号\" column=\"substrate_type\" orderkey=\"substrate_type\" />"+
