...
<%
	...
	if(!p_id.equals("")){
		rs.executeSql("select custid,TZLXNAME,tzbh,tzbb,pkg,pkld,CADGSTZ,YSZLSC,REQUESTID from otecdrmedef_st  where tzbh = '"+ p_id +"' and (tzbb, tzbh) in (select max(To_Number(tzbb)),tzbh from  otecdrmedef_st group by tzbh)  ");
		if(rs.next()){
