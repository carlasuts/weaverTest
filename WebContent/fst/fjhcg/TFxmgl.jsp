...
jQuery(function () {
	...
	function getYearPreSale(idx,yearPre,year2) {
		var  YearPreSale="";
        var PreYsaleroom = "";
        switch (yearPre)
		{
		    ...
		    jQuery("#field" + fielyearPreSale + "_" + idx).val(YearPreSale);
		    document.getElementById("#field" + fielyearPreSale + "_" + idx).readOnly=true;
		    break;
		    case "1" :  //年度信心指数为50%
				jQuery("input[id^='field" + fieldyear1 + "_']").each(function(index) {
					var mxid = this.id.split("_")[1];
		    ...
		    break;
		    case "4" :  //年度信心指数为0%
		    jQuery("#field" + fielyearPreSale + "_" + idx).val(0);
		    document.getElementById("#field" + fielyearPreSale + "_" + idx).readOnly=true;
		    break;
		}
	}
