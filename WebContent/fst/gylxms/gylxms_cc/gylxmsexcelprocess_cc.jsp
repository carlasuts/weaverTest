...
<%
	...
	while( true ) {
        ...
        sql = "select id from md_mdm_std_router_cc where name = '"+bzgylx+"'";
        rs1.executeSql(sql);
        rs1.next();
        String id = rs1.getString("id");
 	sql = "delete from  MD_MDM_STD_ROUTER_item_cc where id = '"+ id +"'";
        rs2.executeSql(sql);
        	sql = "insert into MD_MDM_STD_ROUTER_item_cc (ID ,master_fk,item_no,oper_fk ,factory ) values (SYS_GUID()||'',"+
    				...
    				")";
    	    rs.executeSql(sql); 
            bb.writeLog("MD_MDM_STD_ROUTER_item_cc detailsql:" + sql);
    }
