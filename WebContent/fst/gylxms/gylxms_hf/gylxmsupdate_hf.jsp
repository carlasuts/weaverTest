...
<%
	...
	if(!id.equals("")){
		rs.executeSql("select item_no,factory,oper_fk,master_fk from MD_MDM_STD_ROUTER_item_hf where master_fk ='"+master_fk+"'");
		if(rs.next()){
...
<BODY>
	...
	<%
		...
		//返回
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage()) + ",javascript:location.href='gylxms1list_hf.jsp?id="+master_fk+"',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
	...
	<table width=100% height=100% border="0" cellspacing="0"
		...
		<tr>
			<td></td>
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="gylxms1operation_hf.jsp" method=post>
