...
<%
	...
	String sql = "";
	if(id!= null){
		sql = "select master_fk from MD_MDM_STD_ROUTER_item_st where id = "  + id;
		bb.writeLog(sql);
		rs.executeSql(sql);
		rs.next();
	...
	if(type.equals("del")){
		sql = "delete MD_MDM_STD_ROUTER_item_st where id  = " + id;
		rs.executeSql(sql);
	}
	...
	response.sendRedirect("gylxms1list_st.jsp?id="+master_fk);
%>