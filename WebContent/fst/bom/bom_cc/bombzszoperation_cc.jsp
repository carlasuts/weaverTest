...
<%@include file="/systeminfo/init_wev8.jsp" %>
   <%
    ...
    if(type.equals("del")){
	    sql = "delete obomsetmat_cc where id = " + id;
	    rs.executeSql(sql);
    }
    else if(type.equals("modi")){
    	sql = "update  obomsetmat_cc set factory = '" + factory + "',cust_id = '" + cust_id + "',pkld_grp = '" + pkld_grp + "' ,pkld = '" + pkld + "',pkld_com = '" + pkld_com + "' ,oper_grp = '" + oper_grp + "',mat_type = '" + mat_type + "',mat_id = '" + mat_id + "',mat_desc = '" + mat_desc + "',qty_1 = '" + qty_1 + "',storage_location = '" + storage_location + "',mustfill_flag = '" + mustfill_flag + "',update_user_id = '" + update_user_id + "',update_time = '" + update_time + "' where id = '"+id+"'";
		rs.executeSql(sql);
    }
    else if(type.equals("add")){
    	sql = "insert into obomsetmat_cc (factory,cust_id,pkld_grp,pkld,pkld_com,oper_grp,mat_type,mat_id,mat_desc,qty_1,storage_location,mustfill_flag,create_time,create_user_id) values ("+
    			"'" + factory + "'," +
    			"'" + cust_id + "'," +
				"'" + pkld_grp + "'," +
				"'" + pkld + "'," +
    ...
    response.sendRedirect("bombzsz_cc.jsp");
   %>
