...
<%
	...
	if(!id.equals("")){
		rs.executeSql("select name,factory,\"DESC\" from MD_MDM_STD_ROUTER where id ='"+id+"'");
		if(rs.next()){
...
<BODY>
	...
	<%
		...
		//返回
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage()) + ",javascript:location.href='MD_MDM_STD_ROUTER.jsp',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
	...
	<table width=100% height=100% border="0" cellspacing="0"
		...
		<tr>
			<td></td>
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="MD_MDM_STD_ROUTERoperation.jsp" method=post>
