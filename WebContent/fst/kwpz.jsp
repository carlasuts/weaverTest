...
String gzbh = Util.null2String(request.getParameter("gzbh"));//格子编号
...
<tr>
	...
	<td valign="top">
		...
		<TR>
			...
			<input type="button" value="模板下载" onclick="javascript:window.location.href='kwpz.xls';"></td>
		</TR>
			...
			<tr>
				<td valign="top">
		            ...
		            tableString =" <table instanceid=\"contract\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
		                         ...
		                         "		<head>"+
								 "			<col width=\"80%\" text=\"格子编号\" column=\"gzbh\" orderkey=\"khm\"  />"+
		                         "		</head>"+
								 "		<operates width=\"20%\">";
