...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top" >
		<FORM id=weaver NAME=frmmain STYLE="margin-bottom:0" action="NewProductIntroductionList_cc.jsp" method=post>
		...
		<TABLE width="100%">
			<tr>
				<td valign="top">
		        	<%
		            String backfields = " requestid , '崇川厂'as cq,Customer,type,Packageoutline,Customermtrldescription,Productmaterialcode,time ";
		            String fromSql  = " (select fm.requestid, cq,Customer,Decode(Producetype,'0','AT','1','AO') as type,Packageoutline,Customermtrldescription,Productmaterialcode,  \n" + 
		            				  ...
		            				  " from  formtable_main_143 fm ,Workflow_Requestbase wr \n" + 	
		            				  " where   fm.Requestid = Wr.Requestid  and wr.CURRENTNODETYPE = '3' and wr.workflowid = '3602'  \n" + 	
		            				  " Union all \n" + 	
		            				  ...
		            				  " (replace(LASTOPERATEDATE,'-')||replace( LASTOPERATETIME,':')) as time  \n" + 
		            				  " from  formtable_main_144 fm ,Workflow_Requestbase wr where  Fm.Requestid = Wr.Requestid and wr.CURRENTNODETYPE = '3'   \n" +       
		            				  " and wr.workflowid =  '3603' ) ";
