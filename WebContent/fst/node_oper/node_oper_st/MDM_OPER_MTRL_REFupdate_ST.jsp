...
<%
	...
	if(!id.equals("")){
		rs.executeSql("select oper_fk,mtrl_group_fk,oper_role_fk,oper_role_pk_id ,mustfill_flag from MDM_OPER_MTRL_REF where id ='"+id+"' AND SITE_OPTION = '4000' ");
		if(rs.next()){
...
<BODY>
	...
	<%
		...
		//返回
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage()) + ",javascript:location.href='MDM_OPER_MTRL_REF_ST.jsp',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
	...
	<table width=100% height=100% border="0" cellspacing="0"
		...
		<tr>
			<td></td>
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="MDM_OPER_MTRL_REFoperation_ST.jsp" method=post>
