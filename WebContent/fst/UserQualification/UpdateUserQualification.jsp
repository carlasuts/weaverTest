			...
			<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="OperationUserQualification.jsp" method=post>
				<input type=hidden name=type value='<%=type%>'>
				 ...
				 <TR>
					...
					<td align="left">
						<input type='text' id='TOTAL_REJECT_QTY' name='TOTAL_REJECT_QTY' <%=readOnly%> value='<%=TOTAL_REJECT_QTY%>' />
					</td>
				 </TR>
				 <TR>
					<td align="right">REJECTCODE1_QTY：</td>
					<td align="left">
						<input type='text' id='REJECTCODE1_QTY' name='REJECTCODE1_QTY'  <%=readOnly%> value='<%=REJECTCODE1_QTY%>' />
					</td>
				 </TR>
				 <TR>
					<td align="right">REJECTCODE2_QTY：</td>
					<td align="left">
						<input type='text' id='REJECTCODE2_QTY' name='REJECTCODE2_QTY'  <%=readOnly%> value='<%=REJECTCODE2_QTY%>' />
					</td>
				 </TR>
				 <TR>
					<td align="right">REJECTCODE3_QTY：</td>
					<td align="left">
						<input type='text' id='REJECTCODE3_QTY' name='REJECTCODE3_QTY'  <%=readOnly%> value='<%=REJECTCODE3_QTY%>' />
					</td>
				 </TR>
				 <TR>
					<td align="right">REJECTCODE4_QTY：</td>
					<td align="left">
						<input type='text' id='REJECTCODE4_QTY' name='REJECTCODE4_QTY'  <%=readOnly%> value='<%=REJECTCODE4_QTY%>' />
					</td>
				 </TR>
				 <TR>
					<td align="right">REJECTCODE5_QTY：</td>
					<td align="left">
						<input type='text' id='REJECTCODE5_QTY' name='REJECTCODE5_QTY'  <%=readOnly%> value='<%=REJECTCODE5_QTY%>' />
					</td>
				 </TR>
				 <TR>
					<td align="right">REJECTCODE6_QTY：</td>
					<td align="left">
						<input type='text' id='REJECTCODE6_QTY' name='REJECTCODE6_QTY'  <%=readOnly%> value='<%=REJECTCODE6_QTY%>' />
					</td>
				 </TR>
			     </tbody>
			     </table>
