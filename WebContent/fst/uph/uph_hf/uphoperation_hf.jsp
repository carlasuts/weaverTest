...
<%@include file="/systeminfo/init_wev8.jsp" %>
   <%
    ...
    if(type.equals("del")){
	    sql = "delete MDM_UPH_RULE_hf where id = '"+id+"'";
	    rs.executeSql(sql);
    }
    else if(type.equals("modi")){
    	sql = "update  MDM_UPH_RULE_hf set PKG_OUTLINE_FK = '" + PKG_OUTLINE_FK + "',OPER_FK = '" + OPER_FK + "',SINGLE_ATTACH_TIME = '" + SINGLE_ATTACH_TIME + "',ATTACH_CHANGE_WAFER_TIME = '" + ATTACH_CHANGE_WAFER_TIME + "',SINGLE_WIRE_BOND_TIME = '" + SINGLE_WIRE_BOND_TIME + "',SINGLE_NO_WIRE_TIME = '" + SINGLE_NO_WIRE_TIME + "',SINGLE_GRIND_TIME = '" + SINGLE_GRIND_TIME + "',SCRIBE_METERS = '" + SCRIBE_METERS + "',SCRIBE_CHANGE_WAFER_TIME = '" + SCRIBE_CHANGE_WAFER_TIME + "',UPH_FORMULA = '" + UPH_FORMULA + "' where id = '"+id+"'";
		rs.executeSql(sql);
    }
    else if(type.equals("add")){
    	sql = "insert into MDM_UPH_RULE_hf (id,PKG_OUTLINE_FK,OPER_FK,SINGLE_ATTACH_TIME,ATTACH_CHANGE_WAFER_TIME,SINGLE_WIRE_BOND_TIME,SINGLE_NO_WIRE_TIME,SINGLE_GRIND_TIME,SCRIBE_METERS,SCRIBE_CHANGE_WAFER_TIME,UPH_FORMULA) values (SYS_GUID()||'',"+
				"'" + PKG_OUTLINE_FK + "'," +
				"'" + OPER_FK + "'," +
				"'" + SINGLE_ATTACH_TIME + "'," +
    ...
    response.sendRedirect("uph_hf.jsp");
   %>
