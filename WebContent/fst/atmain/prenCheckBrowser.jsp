...
<%
	...
	String sqlwhere = " 1=1 and  f.mainid = e.id and  e.requestid =  '"+ requestid +"' ";
	int ishead = 0;
...
String tableString = "";
int perpage=10;
String backfields = " f.ITEMNO,f.operadd  ";
String fromSql  = "formtable_main_78 e,formtable_main_78_dt2 f";
e1.writeLog(fromSql);
	tableString =   " <table instanceid=\"db_list3\" tabletype=\"checkbox\" pagesize=\"7\" >"+ //指定分页条数和初始化id以及是否有复选框
			...
			" sqlorderby=\""+orderby+"\"   sqlprimarykey=\"id\" sqlsortway=\"asc\" sqlisdistinct=\"false\" />"+
                "       <head>"+
                "           <col width=\"0%\" hide=\"true\"  text=\""+"ITEMNO"+"\" column=\"ITEMNO\"    />"+
