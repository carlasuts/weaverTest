...
<%
	...
	while( true ) {
        ...
        sql = "select * from workflow_selectitem where fieldid =( select id from workflow_billfield where billid='-91' and fieldname = 'cq')   and selectname = '"+c2+"'";
        rs.executeSql(sql);
        rs.next();
        gcdm = rs.getString("selectvalue");
        sql = "select * from workflow_selectitem where fieldid =( select id from workflow_billfield where billid='-91' and fieldname = 'tzlx')   and selectname = '"+c3+"'";
        rs.executeSql(sql);
        rs.next();
