...
String sqlwhere = " where 1 = 1 and (tzbb, tzbh) in (select max(To_Number(tzbb)),tzbh from  otecdrmedef_cc group by tzbh) ";
...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top" >
		<FORM id=weaver NAME=frmmain STYLE="margin-bottom:0" action="otecdrmedef.jsp" method=post>
...
function doView(id){
	document.frmmain.action = "otecdrmedef_details.jsp?id="+id;
	document.frmmain.submit();
}
