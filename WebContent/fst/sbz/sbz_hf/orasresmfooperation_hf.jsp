...
<%@include file="/systeminfo/init_wev8.jsp" %>
   <%
    ...
    if(type.equals("del")){
	    sql = "delete ORASRESMFO_hf where id =  '"+id+"'";
	    rs.executeSql(sql);
    }
    else if(type.equals("modi")){
    	sql = "update  ORASRESMFO_hf set factory = '" + factory + "',custid = '" + custid + "',pkld = '" + pkld +  "',oper = '" + oper + "',resg_id = '" + resg_id + "' where id = '"+id+"'";
		rs.executeSql(sql);
    }
    else if(type.equals("add")){
    	sql = "insert into ORASRESMFO_hf (id,factory,custid,pkld,oper,resg_id) values (SYS_GUID()||'',"+
				"'" + factory + "'," +
				"'" + custid + "'," +
				"'" + pkld + "'," +
				"'" + oper + "'," +
    ...
    response.sendRedirect("orasresmfo_hf.jsp");
   %>
