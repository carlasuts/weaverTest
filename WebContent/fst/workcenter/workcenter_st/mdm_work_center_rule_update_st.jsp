...
<%
	...
	if(!id.equals("")){
		rs.executeSql("select cust_fk,pkg_outline_fk,oper_fk,vehicle_fk,work_center_fk,DATE_EFFECT from MDM_WORK_CENTER_RULE_st where id ='"+id+"'");
		if(rs.next()){
...
<BODY>
	...
	<%
		...
		//返回
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage()) + ",javascript:location.href='mdm_work_center_rule_st.jsp',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
	...
	<table width=100% height=100% border="0" cellspacing="0"
		...
		<tr>
			<td></td>
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="mdm_work_center_rule_operation_st.jsp" method=post>
