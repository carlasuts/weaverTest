...
<tr>
	...
	<td valign="top">
		...
		<TR>
			...
			<input type="button" value="模板下载" onclick="javascript:window.location.href='malay.xls';"></td>
		</TR>
		...
		<TABLE width="100%">
			<tr>
				<td valign="top">
		        	<%
		            String backfields = " no1,sprsl,molga,lgart,lgtxt,kztxt,wt_en ";
		            String fromSql  = " ZJV_HR_OAWT_BM ";
		            String sqlWhere = sqlwhere;
		            String orderby = " no1 " ;
		            String tableString = "";
		            tableString =" <table instanceid=\"contract\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
		                         "		<sql backfields=\""+backfields+"\" sqlform=\""+fromSql+"\" sqlwhere=\""+Util.toHtmlForSplitPage(sqlWhere)+"\" sqlorderby=\""+orderby+"\" sqlprimarykey=\"no1\" sqlsortway=\"desc\" sqlisdistinct=\"false\"/>"+
		                         "		<head>"+
								 "			<col width=\"10%\" text=\"no1\" column=\"no1\" orderkey=\"no1\"  />"+
