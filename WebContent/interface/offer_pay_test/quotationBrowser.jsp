	...
	<table style="width:80%">
		<tr>
			...
			<td style="width:300px;text-align:left">
					<p><brow:browser name="field19801" viewType="0" hasBrowser="true" hasAdd="false"
...
<script language="javascript">	
	...
	function dochange(){		
		...
		$("#quotationmethod").bind("change", function(){			
			if($("#quotationmethod option:selected").val() == "0"){
				dohide();			
			}else{
				doshow();
			}
	...
	jQuery("#cost_element").click(function(){
        ...
        jQuery.ajax({
            ...
            data: {shape: $("#shape").val(), producttype: $("#producttype").val(), custid: $("#custid").val(), tradeway: $("#tradeway").val()},
            cache: false,
            type: "post",
            dataType: "text",
            async: false,
        ...
        jQuery.ajax({
            ...
            success: function (sb) {
                ...
                if(sb != "" ){
					...
					$("#cost_element_test").val("测试");$("#quotation_mode_test").val("小时");$("#material_cost_test").val(ary2[9]);$("#maintenance_costs_test").val(ary2[10]);$("#artificial_cost_test").val(ary2[11]);$("#power_cost_test").val(ary2[12]);
					...
					$("#one_wrie_1").val("加一根丝");$("#one_wrie_2").val("true");$("#one_wrie_3").val("true");$("#one_wrie_4").val(ary2[27]);$("#one_wrie_5").val(ary2[28]);
					
					$("#ag_cost_1").val("金价波动100$");$("#ag_cost_2").val("true");$("#ag_cost_3").val("true");$("#ag_cost_4").val("0.00");$("#ag_cost_5").val("0.00");
					
					$("#one_chip_1").val("加一个芯片");$("#one_chip_2").val("true");$("#one_chip_3").val("true");$("#one_chip_4").val(ary2[28]);$("#one_chip_5").val(ary2[27]);
                }
            }
        });
    });
