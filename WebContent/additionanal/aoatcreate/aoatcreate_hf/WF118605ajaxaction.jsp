...
if(type.equals("1")){
	...
	sql = "select distinct WORK_CENTER_FK from mdm_work_center_rule_hf where PKG_OUTLINE_FK ='"+gylxdm +"'  and OPER_FK ='"+gxms+"'";
	rs.executeSql(sql);
	rs.next();
	result +="[";
...
if(type.equals("2")){
	...
	sql = "select distinct WORK_CENTER_FK from mdm_work_center_rule_hf where PKG_OUTLINE_FK ='"+gylxdm +"'  and OPER_FK ='"+gxms+"' and CUST_FK = '"+ khh +"' ";
	rs.executeSql(sql);
	rs.next();
	result +="[";
	if(!"".equals(rs.getString("WORK_CENTER_FK"))){
