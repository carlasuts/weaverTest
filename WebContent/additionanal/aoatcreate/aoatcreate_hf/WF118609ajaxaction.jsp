...
String oper = "";
String Producetype = "";
if(Math.abs(formid) == 149){
	sql1 = "SELECT Producetype FROM formtable_main_149 WHERE Requestid = '"+ requestid +"' " ;
	rs1.executeSql(sql1);
	rs1.next();
