...
if(type.equals("1")){
	...
	//sql = "select distinct oper_fk as oper from (SELECT D.ITEM_NO,c.id,c.oper_grp,c.mat_id,d.oper_fk,c.qty_1,c.storage_location,c.mustfill_flag FROM obomsetmat_st c , MD_MDM_STD_ROUTER_item_st d,hrmrolemembers b,MDM_OPER_MTRL_REF a WHERE a.oper_role_pk_id = b.roleid AND d.oper_fk =a.oper_fk AND c.oper_grp  = d.oper_grp AND master_fk = '"+gylxdm +"'  and c.mustfill_flag = 'Y' GROUP BY D.ITEM_NO,c.id,c.oper_grp,c.mat_id,d.oper_fk,c.qty_1,c.storage_location,c.mustfill_flag) ";
