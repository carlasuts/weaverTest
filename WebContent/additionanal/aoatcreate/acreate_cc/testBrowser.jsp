...
String fromSql  = " (select to_char(c.id) as id,  g.ITEMNO,g.operadd,c.mat_id ,c.mat_desc, c.mat_type   ,c.storage_location \n" +
		...
		"(select f.ITEMNO,f.operadd ,mp.oper_grp_4 from formtable_main_143 e,formtable_main_143_dt2 f ,mwipoprdef mp  \n" +
		...
		"(select f.ITEMNO,f.operadd from formtable_main_143 e,formtable_main_143_dt2 f  \n" +
		"  where e.requestid =  " + requestid + " \n" +
		"  and  f.mainid = e.id  ) g  \n" +
...
jQuery(document).ready(function(){
	...
	if(jQuery("#isfirst").val()==''){
		jQuery("#cust_id").val(parentWin.document.getElementById("field18014").value);
		jQuery("#pkld").val(parentWin.document.getElementById("field18083").value);
