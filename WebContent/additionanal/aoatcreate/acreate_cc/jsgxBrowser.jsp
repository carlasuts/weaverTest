...
String sqlwhere = " 1=1 and A.Oper_Fk = Mop.Oper and  b.roleid = c.id and c.rolesmark = a.oper_role_fk and b.resourceid = "+ user.getUID() +" and a.oper_fk in (select operadd from formtable_main_143 a,formtable_main_143_dt2 b where b.mainid = a.id and b.operadd != '0010' and a.requestid =  '"+ requestid +"') ";
	int ishead = 0;
...
String tableString = "";
int perpage=10;
String backfields = " distinct oper_fk ,OPER_DESC ";
String fromSql  = "MDM_OPER_MTRL_REF a ,hrmrolemembers b,hrmroles c , Mwipoprdef mop ";
	tableString =   " <table instanceid=\"db_list3\" tabletype=\"none\" pagesize=\""+perpage+"\"  >"+ //指定分页条数和初始化id以及是否有复选框
			...
			"           <col width=\"100%\"  text=\"描述\" column=\"OPER_DESC\" orderkey=\"OPER_DESC\"   />"+
                "       </head>"+
                " </table>";
%>
