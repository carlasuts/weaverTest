...
String sqlwhere = " 1=1 and  b.roleid = c.id and c.rolesmark = a.oper_role_fk and b.resourceid = "+ user.getUID() +" and a.oper_fk in (select operadd from formtable_main_149 a,formtable_main_149_dt2 b where b.mainid = a.id and b.operadd != '0010' and a.requestid =  '"+ requestid +"') ";
	int ishead = 0;
