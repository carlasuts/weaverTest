...
<%
	...
	while( true ) {
        ...
        String FRAME_FK ="";
        if (c3.equals("A")){
			FRAME_FK = "YXXHESMILKRXWOQN9UFNIU2QITW569MP";
		}else if (c3.equals("B")){
			FRAME_FK = "CD88RYR10AYRLDMU7JD2Y2GNCSM4XHQV";
		}
        
        	sql = "insert into MD_SD_FRM_PKG (id,QTTN_PKG_FK,name,LABOUR,POWER,DEPR,OTHER,MAINTENANCE_COST) values (SYS_GUID()||'',"+
    				"'" + c2 + "'," +
    				"'" + FRAME_FK + "'," +
    				"'" + c4 + "'," +
    				"'" + c5 + "'," +
    				...
    				")";
    	    rs.executeSql(sql); 
            bb.writeLog("插入 MD_SD_FRM_PKG:" + sql);
        //}
        //else{
