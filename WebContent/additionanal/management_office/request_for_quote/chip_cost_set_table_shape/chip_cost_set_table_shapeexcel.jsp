...
<!-- 导入等待 -->
 <div id="loading">	
		<span  id="loading-msg"><img src="/images/loading2.gif">正在导入外形芯片成本设定表数据，请稍候</span>
 </div>

<!-- 结果展示弹出层 -->
<div id="divInfo" title="正在导入外形芯片成本设定表数据，请稍候">
...
function dosubmit(obj) {
    if(check_form(document.frmMain,'excelfile')) {
    	...
    	document.frmMain.action = "/interface/additional/management_office/request_for_quote/chip_cost_set_table_shape/chip_cost_set_table_shapeexcelprocess.jsp";
