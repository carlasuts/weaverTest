...
<%
	...
	String QTTN_PKG_FK = "",EXPRESSION = "";

	RecordSet rs = new RecordSet();
	if(!id.equals("")){
		rs.executeSql("select QTTN_PKG_FK,EXPRESSION from MD_SD_TESTER_UPH where id ='"+id+"'");
		if(rs.next()){
...
<BODY>
	...
	<%
		...
		//返回
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage()) + ",javascript:location.href='appearance_test_UPH.jsp',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
	...
	<table width=100% height=100% border="0" cellspacing="0"
		...
		<tr>
			<td></td>
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="appearance_test_UPHoperation.jsp" method=post>
