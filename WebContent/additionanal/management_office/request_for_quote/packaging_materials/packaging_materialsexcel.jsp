...
<!-- 导入等待 -->
 <div id="loading">	
		<span  id="loading-msg"><img src="/images/loading2.gif">正在导入包装材料数据，请稍候</span>
 </div>

<!-- 结果展示弹出层 -->
<div id="divInfo" title="正在导入包装材料数据，请稍候">
...
function dosubmit(obj) {
    if(check_form(document.frmMain,'excelfile')) {
    	...
    	document.frmMain.action = "/interface/additional/management_office/request_for_quote/packaging_materials/packaging_materialsexcelprocess.jsp";
