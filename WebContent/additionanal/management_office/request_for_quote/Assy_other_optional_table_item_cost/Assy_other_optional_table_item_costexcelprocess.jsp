...
<%
	...
	while( true ) {
        ...
        sql="select id from MD_SD_COST_ASSY_OTHER where name ='"+c2+"'and QTTN_PKG_FK ='"+c3+"'";
        rs.executeSql(sql); 
        while(rs.next()){
        	String COST_ASSY_OTHER_FK =rs.getString("id");
        }
        	...
        	sql = "insert into MD_SD_COST_ASSY_OTHER_OPTION (id,COST_ASSY_OTHER_FK,FULL_NAME,SORT,CURRENCY_FK, MATERIALCOST ,MAINTENANCE_COST ,UC ,LABOUR ,POWER ,DEPR ,OTHER ) values (SYS_GUID()||'',"+
    				...
    				")";
    	    rs.executeSql(sql); 
            bb.writeLog("插入 MD_SD_COST_ASSY_OTHER_OPTION:" + sql);
        //}
        //else{
