...
<%
	...
	String QTTN_PKG_FK = "",PRDC_TYPE_FK = "",MEMO = "";

	RecordSet rs = new RecordSet();
	if(!id.equals("")){
		rs.executeSql("select QTTN_PKG_FK,PRDC_TYPE_FK,MEMO from MD_SD_QTTN_PKG_MEMO where id ='"+id+"'");
		if(rs.next()){
...
<BODY>
	...
	<%
		...
		//返回
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage()) + ",javascript:location.href='quotation_note_table_shape.jsp',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
	...
	<table width=100% height=100% border="0" cellspacing="0"
		...
		<tr>
			<td></td>
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0" action="quotation_note_table_shapeoperation.jsp" method=post>
