 ...
 //to_char(to_date(Allocation_date,'yyyy-mm-dd'),'yyyy/fmmm/dd') Allocation_date,
  ...
  if(test==5){
	  ...
	  backfieldsSec=",khh||'-'||fzlx  as Customer_PKG,jhs,sfl,zpjhg,kjjb,zhj,ddxq,Test_item,Test_condition,"+
			  ...
			  ",(select SELECTNAME from workflow_selectitem where SELECTVALUE =f2.Test_result and  fieldid =( select id from workflow_billfield where billid=-126 and fieldname ='Test_result'))as Test_result,Status,FA_result,FA_failure_mode,FA_Report_No,Fail_Item,Remark";
	  ...
	  tableStringSec= 
				...
				fromSql  = fromSql+" left join formtable_main_126_dt1 f2 on f1.id=f2.mainid";
			    sqlWhere = sqlwhere+"";
			    backfields="(select SELECTNAME from workflow_selectitem where SELECTVALUE =f1.assy_location and  fieldid =( select id from workflow_billfield where billid=-126 and fieldname ='assy_location'))as cpcd,"+backfields;
