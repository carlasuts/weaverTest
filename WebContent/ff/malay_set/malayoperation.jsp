...
<%@include file="/systeminfo/init_wev8.jsp" %>
   <%
    ...
    if(type.equals("del")){
	    sql = "delete ZJV_HR_OAWT_BM where id  = '"+id+"'";
	    rs.executeSql(sql);
    }
    else if(type.equals("modi")){
    	sql = "update  ZJV_HR_OAWT_BM set sprsl = '" + sprsl + "',molga = '" + molga + "',lgart = '" + lgart + "',lgtxt = '" + lgtxt  + "',kztxt = '" + kztxt  + "',wt_en = '" + wten + "' where id = '"+id+"'";
		rs.executeSql(sql);
    }
    else if(type.equals("add")){
    	sql = "insert into ZJV_HR_OAWT_BM(SPRSL, MOLGA, LGART, LGTXT,KZTXT, WT_EN) values ("+				
				"'" + sprsl + "'," +
				"'" + molga + "'," +
				"'" + lgart + "'," +
				"'" + lgtxt + "'," +
