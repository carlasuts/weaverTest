...
<%	
	...
	String shape = Util.null2String(request.getParameter("field19801"));
...
<FORM NAME=SearchForm STYLE="margin-bottom:0;padding:50px;width:1000px;align:center" action="quotationMain.jsp" method=post>
	<table style="width:80%">
		<tr>
			...
			<td style="width:300px;text-align:left"><input id="field19801" name="shape" value="<%=shape%>" style="width:200px"></td>
...
<script language="javascript">	
	jQuery(document).ready(function(){		
		var custid = window.opener.document.getElementById("field56922").value;
		jQuery("#custid").val(custid);
		var shape = window.opener.document.getElementById("field19801").value;
		jQuery("#field19801").val(shape);
		var producttype = window.opener.document.getElementById("field19681").options[window.opener.document.getElementById("field19681").selectedIndex].text;
		jQuery("#producttype").val(producttype);
		var tradeway = window.opener.document.getElementById("field19665").options[window.opener.document.getElementById("field19665").selectedIndex].text;
		jQuery("#tradeway").val(tradeway);
		uuid = window.opener.document.getElementById("field21821").value;		
		var silk = window.opener.document.getElementById("field22327").value;
		jQuery("#silk").val(silk);
		var chipX = window.opener.document.getElementById("field22330").value;
		jQuery("#chipX").val(chipX);
		var chipY = window.opener.document.getElementById("field22331").value;
	...
	function doupdate(){
		jQuery("#fastbtn").click(function(){	
			jQuery.ajax({				
					url: "/interface/ff/Quotation/quotationBrowserCalculate08.jsp",						
					data: {uuid: uuid, shape: $("#field19801").val(), producttype: $("#producttype").val(), custid: $("#custid").val(), tradeway: $("#tradeway").val(), 
