...
<BODY>
	...
	<!-- 导入等待 -->
	<div id="loading">
		<span id="loading-msg"><img src="/images/loading2.gif">正在导入批数量数据，请稍候</span>
	</div>

	<!-- 结果展示弹出层 -->
	<div id="divInfo" title="正在导入批数量数据，请稍候">
		<DIV
	...
	<script language=javascript>
		...
		function dosubmit(obj) {
			if (check_form(document.frmMain, 'excelfile')) {
				...
				document.frmMain.action = "/interface/rework/cc/so/oinrwsodopexcelprocess.jsp";
