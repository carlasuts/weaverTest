...
<%
	...
	if (!id.equals("")) {
		rs.executeSql("select cust_id, name, work_code from oinrwsodop_st where id ='" + id + "'");
		if (rs.next()) {
...
<BODY>
	...
	<%
		...
		RCMenu += "{" + SystemEnv.getHtmlLabelName(1290, user.getLanguage())
				+ ",javascript:location.href='oinrwsodop.jsp',_self} ";
		RCMenuHeight += RCMenuHeightStep;
	%>
		...
		<tr>
			...
			<td valign="top">
				<FORM id=weaver NAME=frmmain STYLE="margin-bottom: 0"
					action="oinrwsodopoperation.jsp" method=post>
