...
if(!"".equals(requestid)){
	if(Quotation_way.equals("0")){
		sql = "SELECT Adv_mat_assy, Oth_mat_assy, Mat_com_assy, artifi_assy, power_assy, deprect_assy, maintain_assy, other_assy, thou_tal_cost_assy, tester_time, hander_time, mat_time, " +
			  ...
			  "from formtable_main_205 a left join Offer_to_apply_middle b on a.guid = b.ID where a.requestid ='" + requestid + "'";
		...
		// BigDecimal OTH_MAT_ASSY_MATH = (OTH_MAT_ASSY == "" ? new BigDecimal(0) :new BigDecimal(OTH_MAT_ASSY));// 其他材料 485.15
		OTH_MAT_ASSY = MAT_COM_ASSY_MATH.subtract(ADV_MAT_ASSY_MATH).toString();
		// BigDecimal MAT_COM_ASSY_MATH =OTH_MAT_ASSY_MATH.add(ADV_MAT_ASSY_MATH); //材料合计 （数字）485.15 + 457.36
