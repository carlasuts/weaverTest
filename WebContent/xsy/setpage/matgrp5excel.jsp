...
<%!
	final static String name = "客户品名与未定义信息对应关系";
%>
...
<!-- 导入等待 -->
 <div id="loading">	
		<span  id="loading-msg"><img src="/images/loading2.gif">正在导入<%=name%>数据，请稍候</span>
 </div>

<!-- 结果展示弹出层 -->
<div id="divInfo" title="正在导入<%=name%>数据，请稍候">
...
var timeId;  //定时器
var yourname = "xsy"; //你的名字，即自定义文件夹名
var excelprocess = "matgrp5excelprocess"; //excelprocess的全称
...
function dosubmit(obj) {
    if(check_form(document.frmMain,'excelfile')) {
    	...
    	document.frmMain.action = "/interface/" + yourname + "/setpage/" + excelprocess + ".jsp";
