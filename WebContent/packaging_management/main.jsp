...
<script type="text/javascript">
	...
	jQuery(function () {
		...
		var sbidbbh =  parseInt($("#field"+zfidbbhid).val());
			jQuery.ajax({
				...
				url: "/interface/packaging_management/packaging_management_03.jsp",
		...
		<%if(nodeid ==node0201 || nodeid == node0202 || nodeid ==nodeG1){%>
			...
			$.ajax({
				...
				url: "/interface/packaging_management/packaging_management_02.jsp",
	...
	//根据申请人带出厂区
		jQuery.ajax({
			url: "/interface/packaging_management/packaging_management_04.jsp",
	...
	function doadd(){	
		...
		if(sqlx == "0"){//新建
			jQuery.ajax({
				url: "/interface/packaging_management/packaging_management_01.jsp",
